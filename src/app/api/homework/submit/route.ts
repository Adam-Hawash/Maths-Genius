...
export async function POST(request) {
  try {
    ...
    /* (2026-و87) إشعار ولي الأمر — واجب من غير أسئلة مقالية: الدرجة نهائية
       ...
       (2026-و96) بقى fire-and-forget جوه after() — طلب المستر «الإشعار
       يوصل في ثانية»: ما بنوقفش رد التسليم نداء web-push، والإشعار
       بيتبعت أول ما الرد يطلع */
    ...
    var backgroundGrading = async function() {
      ...
      try {
        ...
        console.error('[hw-submit] parent notify bg error (ignored):', pnErr)
      }
