...
export async function POST(request: Request) {
  try {
    ...
    var contextStr = [
      ...
      '2) إحنا منصة ماث للمرحلة الإعدادية. استخدم المصطلحات العربية المدرسية فقط: الأسس، الجذور، المعادلات، الكسور (البسط والمقام)، النسبة والتناسب، الهندسة، الجبر، الإحصاء.',
      '3) ممنوع نهائياً المصطلحات الإنجليزية في أسماء الدروس والواجبات: قول "واجب الأسس" مش "واجب powers"، و"درس الجذور" مش "roots".',
