...
var DEFAULTS = {
  ...
  tips_card3_desc: 'حاول فهم لماذا وليس كيف فقط',
  ...
  guide_subtitle: 'ست خطوات بسيطة لتبدأ رحلتك',
...
export async function PUT(request) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to update config', detail: error.message }, { status: 500 })
  }
}
