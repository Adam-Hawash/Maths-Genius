...
export default function SchedulePage() {
  ...
  /* (و72) النصوص حسب اللغة — عربي بقرا المفتاح الأساسي، إنجليزي بقرا *_en */
  ...
  let brandName = 'Math Genius — Mr.Wael Khodair'
  ...
  try {
    ...
    /* (و72) الإنجليزي: لو الأدمن كاتب النسخ الإنجليزية نستخدمها */
    if (lang === 'en') {
