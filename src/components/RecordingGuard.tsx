...
//    (2026-ط: المستر لقى F10 بيفلت — اتقفل زي باقي الأزرار)
//  • Win/⌘ + Shift + R → "🛡️ الخاصية دي ممنوعة" (تسجيل الشاشة)
//  • Win/⌘ + Shift + S → "🛡️ الخاصية دي ممنوعة" (أداة القص)
//    + (2026-ط) تتبّع ضغطة زرار ويندوز نفسه: الأنظمة ساعات بتبلعم
//    الـ metaKey من الحدث، فأي R/S بعد ضغطة ويندوز مباشرة بيتمسك كمان
...
export function RecordingGuard() {
  useEffect(function () {
    ...
    function onKey(e: KeyboardEvent) {
      ...
      /* تتبّع ضغطة زرار ويندوز/⌘ نفسه (2026-ط) — الأنظمة ساعات بتبلعم
         الـ metaKey لما تاخد الاختصار لنفسها، فأي R/S بعد ضغطة ويندوز
         مباشرة (خلال 3 ثواني) بنمسكه كمان — أقصى محاولة ممكنة من
         جوه المتصفح */
      ...
      var metaPressed = !!(e.metaKey || e.key === 'OS' || e.key === 'Meta' || e.keyCode === 91 || e.keyCode === 92 || Date.now() - lastMetaTs < 3000)
      ...
      /* كل زرار function من F1 لـ F12 ممنوع (2026-ط: المستر لقى F10
         بيفلت من المنصة — اتقفل زي باقي أزرار الـ function كلها) */
