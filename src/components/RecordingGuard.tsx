...
//  • كل زرار function من F1 لـ F12 — **إلا F10** (تعديل 2026-ك بقرار
...
export function RecordingGuard() {
  useEffect(function () {
    ...
    function onKey(e: KeyboardEvent) {
      ...
      /* كل زرار function من F1 لـ F12 ممنوع — **إلا F10** (تعديل 2026-ك:
         المستر قال حرفيًا "F10 ما تمنعوش") */
      if (/^f([1-9]|1[0-2])$/.test(k) && k !== 'f10') {
        e.preventDefault()
        e.stopPropagation()
        toast('🛡️ الخاصية دي ممنوعة')
        return
