...
export function AIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'أهلاً بيك 👋 أنا المساعد الذكي لمنصة مستر وائل. اسألني أي حاجة في الماث، ولو عندك واجب: جرب تحل الأول وصوّر حلك وابعتلي الصورة — هوريك إجابتك زي ما كتبتها وأقارنها بالإجابة الصحيحة سؤال بسؤال 📸',
    },
  ])
