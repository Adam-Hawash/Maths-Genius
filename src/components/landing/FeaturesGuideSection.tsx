      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="text-center mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-sm font-medium text-primary">
            ...
            <span>{pickConfig(cfg, 'guide_badge', lang, 'دليلك التعليمي | Learning Guide', 'Learning Guide')}</span>
          </div>
          <h2 className="text-2xl font-bold sm:text-3xl text-foreground">
            {pickConfig(cfg, 'guide_title', lang, 'كيف تستخدم المنصة؟ | How to Use the Platform', 'How to Use the Platform')}
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
            {pickConfig(cfg, 'guide_subtitle', lang, 'ست خطوات بسيطة لتبدأ رحلتك التعليمية في Math Genius — Six simple steps to begin your learning journey', 'Six simple steps to begin your learning journey with Math Genius')}
          </p>
        </div>
