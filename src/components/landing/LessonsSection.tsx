    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <Badge className="mb-3 bg-[#C49A38]/10 text-[#8B6914] dark:text-[#E5BE5A] border-[#C49A38]/30 hover:bg-[#C49A38]/20">
        ...
        <div className="flex justify-center mb-8">
          <select
            ...
            className="h-10 rounded-lg border border-[#C49A38]/30 bg-background text-foreground px-4 text-sm appearance-none cursor-pointer"
          >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {videos.map(function(v) {
              ...
              return (
                <Card
                  key={v.id}
                  className="bg-card border-[#C49A38]/20 overflow-hidden cursor-pointer group hover:border-[#C49A38]/50 transition-all hover:shadow-lg hover:shadow-[#C49A38]/5"
                ...
                >
                  <div className="relative aspect-video bg-black/50">
                    {thumb ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center"><PlayCircle className="h-10 w-10 text-muted-foreground/20" /></div>
                    )}
                    {/* Lock Overlay */}
                  ...
                  <div className="p-3 space-y-1.5">
                    <p className="font-semibold text-sm text-foreground truncate group-hover:text-[#8B6914] dark:group-hover:text-[#E5BE5A] transition-colors">{v.title}</p>
                    <div className="flex items-center justify-between">
                      <Badge variant="outline" className="text-[10px] border-[#C49A38]/30 text-[#8B6914] dark:text-[#C49A38]">{gradeShort}</Badge>
