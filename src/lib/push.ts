...
/* ============================================================
   ✏️✏️ مفاتيح VAPID — مولدة مرة واحدة لمنصة Maths Genius ✏️✏️
   ============================================================ */
var VAPID_PUBLIC_KEY = 'BJp_5YEdBJGjPUHLwcv5RTp5LkEDtzmiZpzVMd9gUutvUahcHprcWOL1CWw-xzaXePPr9w0dDXNKJZWxtcKcCXM'
var VAPID_PRIVATE_KEY = 'ZLNcl3jtDPhwJODuoFIVO5MryqkTjdjmUESlGhzm01U'
var VAPID_SUBJECT = 'mailto:mathsgenius@platform.com'
...
/* إرسال إشعار لكل أجهزة ولي الأمر — بيرجّع عدد المرسل/الفاشل.
   ...
   (2026-و96) الأجهزة بتبعت **متوازي** (كانت ورا بعض — لو أول جهاز
   علق 10 ثواني التاني بيستنيه = تأخير الإشعار كله) — طلب المستر:
   الإشعار يوصل في ثانية. */
